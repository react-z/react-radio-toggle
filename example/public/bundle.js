	  ...
	  _createClass(TestComponent, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Toggle2.default, { items: items, checked: 'apple', name: 'toggleFruits',
	  ...
	  _createClass(Toggle, [{
	    ...
	    value: function render() {
	      ...
	      var radioItems = items.map(function (item, i) {
	        if (item === checked) {
	          return _react2.default.createElement('label', { key: i }, _react2.default.createElement('input', { type: 'radio', defaultChecked: true, name: name,
	            onClick: _this2.handleClick.bind(_this2) }), _react2.default.createElement('span', null, item));
	        } else {
	          return _react2.default.createElement('label', { key: i }, _react2.default.createElement('input', { type: 'radio', name: name,
	            onClick: _this2.handleClick.bind(_this2) }), _react2.default.createElement('span', null, item));
	        }
	      });

	      return _react2.default.createElement('div', { id: name, className: 'toggle' }, radioItems);
	    }
	  }]);
